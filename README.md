...
- **Extensions**: add your own results with a small script — examples for qBittorrent (download progress), Jenkins (build status, start builds) and 2FA codes from an Ente Auth export. See [docs/extensions.md](docs/extensions.md)
